...
public final class RadarServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.sdia.radarservice.grpc.stubs.Radar.DetectRequest,
      com.google.protobuf.Empty> getDetectInfractionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "DetectInfraction",
      requestType = com.sdia.radarservice.grpc.stubs.Radar.DetectRequest.class,
      responseType = com.google.protobuf.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.sdia.radarservice.grpc.stubs.Radar.DetectRequest,
      com.google.protobuf.Empty> getDetectInfractionMethod() {
    io.grpc.MethodDescriptor<com.sdia.radarservice.grpc.stubs.Radar.DetectRequest, com.google.protobuf.Empty> getDetectInfractionMethod;
      ...
      synchronized (RadarServiceGrpc.class) {
        if ((getDetectInfractionMethod = RadarServiceGrpc.getDetectInfractionMethod) == null) {
          RadarServiceGrpc.getDetectInfractionMethod = getDetectInfractionMethod = 
              io.grpc.MethodDescriptor.<com.sdia.radarservice.grpc.stubs.Radar.DetectRequest, com.google.protobuf.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "RadarService", "DetectInfraction"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sdia.radarservice.grpc.stubs.Radar.DetectRequest.getDefaultInstance()))
  ...
  public static abstract class RadarServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void detectInfraction(com.sdia.radarservice.grpc.stubs.Radar.DetectRequest request,
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.sdia.radarservice.grpc.stubs.Radar.DetectRequest,
  ...
  public static final class RadarServiceBlockingStub extends io.grpc.stub.AbstractStub<RadarServiceBlockingStub> {
    ...
    /**
     */
    public com.google.protobuf.Empty detectInfraction(com.sdia.radarservice.grpc.stubs.Radar.DetectRequest request) {
  ...
  public static final class RadarServiceFutureStub extends io.grpc.stub.AbstractStub<RadarServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty> detectInfraction(
        com.sdia.radarservice.grpc.stubs.Radar.DetectRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DETECT_INFRACTION:
          serviceImpl.detectInfraction((com.sdia.radarservice.grpc.stubs.Radar.DetectRequest) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        default:
  ...
  private static abstract class RadarServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.sdia.radarservice.grpc.stubs.Radar.getDescriptor();
    }
